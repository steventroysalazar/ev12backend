...
- Alarm clear events from webhook are also supported:
  - `SOS Ending` / `SOS End` clears the current alarm (`alarmCode = null`)
  - GEO end-like events (`GEO-1 ... End/Ending/Clear/Cancel`) also clear the current alarm
